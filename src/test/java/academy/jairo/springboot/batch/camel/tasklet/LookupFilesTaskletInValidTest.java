...
public class LookupFilesTaskletInValidTest extends BaseTaskletUtil {
    ...
    public void setup() throws IOException {
        ...
        FileStructureUtil.copyResourceTo(FileCreator.INVALID_FILE, getReceivedPathValue());
    ...
    @Test
    public void shouldExecuteInValidFile() throws Exception {

        assertTrue(new File(getReceivedPathValue()+ "/" + FileCreator.INVALID_FILE).exists());
